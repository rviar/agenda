            ...
            if (!(await job.isExpired())) {
                ...
                if (!job.attrs.nextRunAt || job.attrs.nextRunAt <= now) {
                    ...
                    if (runIn > this.processEvery) {
                        ...
                        if (lockedJobIndex === -1) {
                            // lookup by id
                            lockedJobIndex = this.lockedJobs.findIndex(j => { var _a, _b; return ((_a = j.attrs._id) === null || _a === void 0 ? void 0 : _a.toString()) === ((_b = job.attrs._id) === null || _b === void 0 ? void 0 : _b.toString()); });
                        }
                        if (lockedJobIndex === -1) {
        ...
        if ((!jobDefinition.concurrency || !status || status.running < jobDefinition.concurrency) &&
            ...
            try {
                ...
                if (runningJobIndex === -1) {
                    // lookup by id
                    runningJobIndex = this.runningJobs.findIndex(j => { var _a, _b; return ((_a = j.attrs._id) === null || _a === void 0 ? void 0 : _a.toString()) === ((_b = job.attrs._id) === null || _b === void 0 ? void 0 : _b.toString()); });
                }
                if (runningJobIndex === -1) {
